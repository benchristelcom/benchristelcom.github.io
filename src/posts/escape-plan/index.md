...
- Use an ad blocker.
    ...
    - [AdGuard for Chrome],
    - [Orion Browser] for macOS, iPhone, and iPad,
...
At this stage, work on recognizing the psychological effects of addictive /
compulsive internet use. The effects range from extremely obvious and
distressing to subtle and mild. Unfortunately, the more obvious an effect is,
the later it arrives, and by that time it's too late to do anything about it.
...
you might be able to get the "rose without the thorn" — i.e. the dopamine hit
from doomscrolling without the anxiety that follows it. But this feeling is a
lie; you can never do that.

The good news is that all of these effects are temporary. As you start to get
out of the "doom loop," they will become less intense and less frequent.
...
This stage is all about curating your tech experience. The goal is to make
computers fun and personal again.

This might seem like a distraction from the rest of the path, but fun is
important. Without this stage, the escape from tech addition looks like monkish
austerity — bleh! Austerity is not the point. The point is to have a better,
happier life.

### Technical practices for Stage II
...
- [Started a community of personal websites](https://waywardweb.org/). At the
  start, this involved cold-emailing people and asking them to join, which was
  pretty scary! What I learned from this experience is that people who have
  websites are *really* nice and tend to *love* hearing from a human who
  genuinely likes their work. (And yes, people *will* join your webring if you
  ask nicely.)

Of course, you don't have to do these particular things. I'm sure you can think
of much cooler ones.

### Personal practices for Stage II

Get involved. Tinker. Mess around. Fail at something. Laugh and try again.
Curate your experiences and set a high bar for what you allow into your life.

In addition to being fun, all of these practices will help you develop greater
mindfulness, which is crucial for the following stages.

## III. The Harmless Default Activity

So far, the journey has been an uphill climb. This stage represents a "peak" of
sorts. It's a pivotal moment, a turning point, and the path gets somewhat
easier from here on out.

### Technical Practices for Stage III

In this stage, you use your enhanced mindfulness and greater control of your
technological environment to choose a *harmless default activity*. The harmless
default activity is the thing you do by default when you have that compulsive
urge to do *something* with a computer/phone but don't really know what.
...
experience is that of old-school TV or radio. There's no way to skip a video,
pause, or jump backward or forward. It's just you and a stream of images and
sounds that runs at its own pace.
...
There's also some "normal nerd stuff" like [classical music concerts][concerts] and
[Adam Savage making movie prop replicas in his San Francisco "Cave"](https://www.youtube.com/@tested) and
[Max Miller's show "Tasting History"](https://www.youtube.com/@TastingHistory).

The point is, all this stuff is pleasant and restorative, but not something
I'm unable to tear myself away from.

It's like nature. It heals me, but it doesn't need me. It demands nothing and
gives everything.

### Personal practices for Stage III

In this stage, the goal is to remove aspects of your tech experience that cause
psychological lock-in, restlessness, anxiety, and depression, and replace them
with the Harmless Default Activity. This takes a little bit of mindfulness and
willpower, but if you remind yourself of the bad effects you're avoiding, it's
not too hard.

Don't get too attached to the harmless default activity, because it too will
eventually fall away once it's no longer needed.

Another practice that can help at this stage is maintaining a regular schedule
or daily routine. Having something to do reduces the urge to do something, if
that makes sense.
...
Meditation is just the process of calming your mind down.[^1] A calm mind can let go of
the compulsive craving for pleasure and stimulation, and look at reality with
less fear and anxiety. That's helpful for overcoming tech addiction as well as
many other problems.
...
in. That is why meditation generally involves sitting still with your eyes
...
with "intervals" (bells every 5 minutes) helped me sit for 30 minutes without
feeling like I had been sucked into a timeless void. Getting to that point took
two years.

Then, in 2024, I discovered [OnThatPath]'s YouTube series[^2], and everything
...
you put down when you no longer need it.

## V. Renunciation

At this point, you can clearly distinguish good tech experiences from the bad
ones that harm your mental state. You can often resist the temptation to
doomscroll. However, it's not consistent. Sometimes you give in to temptation.

### Technological practices for Stage V

In this stage, you can use your moments of strength to prepare for moments of
weakness. Adjust your tech environment so you don't need as much willpower.

One tool that I have found useful for warding off harmful distractions is
[LeechBlock]. This is a very configurable browser extension that can block
...
It may be painful to realize that some of the things you enjoy doing are, in
fact, psychologically harming you. For me, one example is
[Heroes of Might and Magic IV][hommiv]. This is an old game (made in 2002) that I absolutely
adore. It's a campy high-fantasy pastiche that draws heavily from D&D. The art
is (mostly) gorgeous, and I can never get tired of the soundtrack. And yet, as
much as I love *playing* it, I realized that *trying to play optimally and win*
was causing mental lock-in that would leave me restless and slightly anxious
for hours afterward.
...
## VI. The computer as tool

Gradually, over a period of perhaps years, you will find that you rely on the
computer less and less. You will begin to see that the set of apps and websites
you really need, to live your life and be happy, is very small. You will use
those apps, gladly, and let the rest fall away.
...
At some point, the computer will be fully "toolified" for you. Its enchanting
pull will be gone, its siren song forever silent. It will be something you pick
up to do a task and put down when you're finished, like a screwdriver.

If you've kept up with your meditation practice, your mind will also be pliant:
ready to work whenever you tell it to, ready to rest whenever you tell it to.
...
get to Stage VI, you'll discover something that's a little *weird*, and you
might become curious about it. So I'll tell you about it.

This world you inhabit is full of billions of other people
(I'm sure you've noticed this already — just restating the obvious). But here's
...
And what you can now see very clearly is that this culture is *made up*. Not
only is it made up, it is *cuckoo bananas*. It has virtually nothing to do with
...
> The shaman — wherever he or she does their shamanizing — the shaman is a person
> who is able to transcend the dimensional confines of cultural existence. The
> people they serve are like children within the game of culture. Only the
> shaman knows that culture is a game; everyone else takes it seriously. That's
> how he can do his magic.
>
> You could always tell the shaman, because first of all he usually didn't
> come out to see who was there, even though no one ever came, even though these
> people had visitors maybe once every six months. The guy who wouldn't come out
> of his hut for the only event in six months was inevitably the shaman. And
> when you met him, he wasn't interested in your velcro, or your break-apart
> glow-in-the-dark little trampettes, or any of the rest of it. He was looking
> straight at you, through the eyes outside of culture, saying "What kind of a
> person are you? Are you a fool? Or are you a clever fella? What is your
...
are [wearing green goggles].

(In _The Wonderful Wizard of Oz_, the Emerald City is not actually emerald
green, but all the inhabitants think it is because they've worn green-tinted
goggles all their lives.)

Twenty-first century Western society does not, however, recognize shamans, so
at this point you have two options:

1. Withdraw from the world and become a hermit.
2. Participate, meet people where they are, and try not to go insane.

You can do some combination of these, and it's really not as bad or alarming
as it sounds. You'll just have to accept that a lot of the time you're around
other people you'll be holding your tongue, because if you said what you were
thinking it would sound insane to everyone around you and they'd just change
the subject.

## VIII. Nirvana

The discomfort of being a shaman in a world without shamans will push you
into some degree of seclusion. Or, if you're more extroverted, you might
dedicate your newfound free time to a life of service.

Both of these are good practices for spiritual growth, and, if you continue
meditating, you may at some point reach enlightenment/nirvana. I have not gotten
to this stage, but others report that is a *permanent* freedom from all
craving, restlessness, and fear. It is also, incidentally, the end of the
ego-self. What I *think* this means is that instead of you deciding what to do,
your body and mind just automatically do what your best self *would* do,
meaning that "you" get to retire permanently and watch the body do all your
chores. "Your" work is done.

![Frodo saying "it's done" with the fires of Mount Doom in the background](https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fmedia1.tenor.com%2Fm%2FwHWOKt31cpgAAAAC%2Fits-done-frodo.gif&f=1&nofb=1&ipt=0850cd9362510845a9ed971bdd05e325860a862450ad94b624bebe33426e634f)

> A self is a terrible thing to lose.

...and a Ring of Power is a terrible thing to lose, when there are those who would
use it against you. But it is not such a bad thing to destroy, though the journey
be long and arduous.
...
[her website]: https://birdycards.com/
[portal]: https://benchristel.com/portal/
[justdeleteme]: https://justdeleteme.xyz/
[uBlock Origin for Firefox]: https://addons.mozilla.org/en-US/firefox/addon/ublock-origin/
[uBlock DNS]: https://ublockdns.com/
[AdGuard for Chrome]: https://chromewebstore.google.com/detail/adguard-adblocker/bgnkhhnnamicmpeenaelnjfhikgbkllg
