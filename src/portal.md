...
- [larham/searchpass](https://github.com/larham/searchpass) - A shell script that checks if your password was exposed in any known data breaches, *without* revealing it to any third party. If you're a programmer, you'll appreciate the elegant approach this tool takes. Made by my colleague Larry Hamel.
